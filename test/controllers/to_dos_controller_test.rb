...
class ToDosControllerTest < ActionController::TestCase
  ...
  test "should create to_do" do
    assert_difference('ToDo.count') do
      post :create, to_do: { completed: @to_do.completed, due_date: @to_do.due_date, name: @to_do.name }
    end
  ...
  test "should update to_do" do
    patch :update, id: @to_do, to_do: { completed: @to_do.completed, due_date: @to_do.due_date, name: @to_do.name }
    assert_redirected_to to_do_path(assigns(:to_do))
  end
